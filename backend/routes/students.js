...
router.get('/department/:department', authMiddleware, studentController.getStudentsByDepartment);

// Get students by level (protected route)
router.get('/level/:level', authMiddleware, studentController.getStudentsByLevel);
